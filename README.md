# The Effect of Rising Social Media Addiction on Shopping Behaviour
...
## Motivation
Social media has evolved into one of the most influential environments in modern life. It creates trend adn turns them into cycles of consumption. The constant exposure to these trends evolves into a strong link between online engagement and consumer behavior. My main motivation is to understand if constant exposure to social media alters consumption habits and which demographic groups are affected by this exposure the most.

## Data Sources and Collection
For this project I am going to make use of the datasets I found on Kaggle. I am going to use Python libraries such as numpy, pandas to clean and take the useful parts of the found data. Next, I am going to use matplotlib to get a better visual representation of the foundings from the project. I am going to include datasets on recordeed screen times, demographical groups and consumer behaviour on purchasing. I am planning to add supportive datasets as well to strengthen my claim. This data integration will result in constructing a coherent analytical framework. Cleaning, standardization, and normalization steps will ensure comparability across heterogeneous sources.
